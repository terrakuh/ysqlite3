...
public:
	...
	enum file_cntl
	{
		file_ctnl_lock_state            = SQLITE_FCNTL_LOCKSTATE,
		file_ctnl_get_lock_proxy_file   = SQLITE_FCNTL_GET_LOCKPROXYFILE,
		file_ctnl_set_lock_proxy_file   = SQLITE_FCNTL_SET_LOCKPROXYFILE,
		file_ctnl_last_errno            = SQLITE_FCNTL_LAST_ERRNO,
		file_ctnl_size_hint             = SQLITE_FCNTL_SIZE_HINT,
		file_ctnl_chunk_size            = SQLITE_FCNTL_CHUNK_SIZE,
		file_ctnl_file_pointer          = SQLITE_FCNTL_FILE_POINTER,
		file_ctnl_sync_omitted          = SQLITE_FCNTL_SYNC_OMITTED,
		file_ctnl_win32_av_retry        = SQLITE_FCNTL_WIN32_AV_RETRY,
		file_ctnl_persist_wal           = SQLITE_FCNTL_PERSIST_WAL,
		file_ctnl_overwrite             = SQLITE_FCNTL_OVERWRITE,
		file_ctnl_vfsname               = SQLITE_FCNTL_VFSNAME,
		file_ctnl_powersafe_overwrite   = SQLITE_FCNTL_POWERSAFE_OVERWRITE,
		file_ctnl_pragma                = SQLITE_FCNTL_PRAGMA,
		file_ctnl_busy_handler          = SQLITE_FCNTL_BUSYHANDLER,
		file_ctnl_temp_filename         = SQLITE_FCNTL_TEMPFILENAME,
		file_ctnl_mmap_size             = SQLITE_FCNTL_MMAP_SIZE,
		file_ctnl_trace                 = SQLITE_FCNTL_TRACE,
		file_ctnl_has_moved             = SQLITE_FCNTL_HAS_MOVED,
		file_ctnl_sync                  = SQLITE_FCNTL_SYNC,
		file_ctnl_commit_phase_two      = SQLITE_FCNTL_COMMIT_PHASETWO,
		file_ctnl_win32_set_handle      = SQLITE_FCNTL_WIN32_SET_HANDLE,
		file_ctnl_wal_block             = SQLITE_FCNTL_WAL_BLOCK,
		file_ctnl_zipvfs                = SQLITE_FCNTL_ZIPVFS,
		file_ctnl_rbu                   = SQLITE_FCNTL_RBU,
		file_ctnl_vfs_pointer           = SQLITE_FCNTL_VFS_POINTER,
		file_ctnl_journal_pointer       = SQLITE_FCNTL_JOURNAL_POINTER,
		file_ctnl_win32_get_handle      = SQLITE_FCNTL_WIN32_GET_HANDLE,
		file_ctnl_pdf                   = SQLITE_FCNTL_PDB,
		file_ctnl_begin_atomic_write    = SQLITE_FCNTL_BEGIN_ATOMIC_WRITE,
		file_ctnl_commit_atomic_write   = SQLITE_FCNTL_COMMIT_ATOMIC_WRITE,
		file_ctnl_rollback_atomic_write = SQLITE_FCNTL_ROLLBACK_ATOMIC_WRITE,
		file_ctnl_lock_timeout          = SQLITE_FCNTL_LOCK_TIMEOUT,
		file_ctnl_data_version          = SQLITE_FCNTL_DATA_VERSION,
		file_ctnl_size_limit            = SQLITE_FCNTL_SIZE_LIMIT
	};
